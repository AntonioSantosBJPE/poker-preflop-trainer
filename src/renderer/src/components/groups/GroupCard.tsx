        ...
        {editing ? (
          <>
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <button type="button" className="pt-btn-primary text-sm" onClick={() => void handleSaveRename()}>
                Salvar
              </button>
              <button
                type="button"
          ...
          <>
            <Link to={`/groups/${group.id}`} className="font-display text-lg font-semibold text-foreground hover:text-primary">
              {group.name}
            </Link>
